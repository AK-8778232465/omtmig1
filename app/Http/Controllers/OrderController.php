...
// dd($statusCountsQuery->where('status_id', 15)->get());
// return response()->json($statusCountsQuery->where('status_id', 15)->get());
...
// return response()->json($statusCountsQuery->where('oms_order_creations.status_id',16)->count());
