...
@section('content')
    <style>
        #filename-display {
            ...
            /* Makes the element fit the content */
        }
                    ...
                    <div class="card-body rounded shadow-sm " style="border-top:3px solid #0e7c31">
                        <div class="form-group row mb-4 pb-0 pl-3 pr-3 mt-3">
                            <div class="form-group col-lg-3 mb-3 pb-0">
                                ...
                                <select id="select_client_id" name="select_client_id" class="form-control select2dropdown"
                                    style="width:100%" autocomplete="off" placeholder="Select Lob">
                                    <option selected="" disabled="" value="">Select Client</option>
                                    @foreach ($clients as $client)
                                        <option value="{{ $client->id }}" data-client-id="{{ $client->id }}">
                            ...
                            <div class="form-group col-lg-3 mb-3 pb-0">
                                ...
                                <input type="text" id="order_id" name="order_id" class="form-control"
                                    ...
                                    data-parsley-trigger="focusout keyup" maxlength="20">
                            </div>
                            {{-- new changes --}}
                            <div class="form-group col-lg-3 mb-3 pb-0">
                                <label for="order_date" class="font-weight-bold">Order Received Date and Time<span
                                        style="color:red;">*</span></label>
                                <br>
                                <div class="input-container">
                                    <input type="datetime-local" id="order_date" class="form-control" step="1"
                                        name="order_date" required data-parsley-trigger="focusout keyup"
                                        data-parsley-error-message="Order Received Date and Time should not be empty"
                                        format="MM-DD-YYYY THH:mm" hour24="true">
                                </div>
                            </div>
                            <div class="form-group col-lg-3 mb-3 pb-0">
                                <label class="font-weight-bold">Lob<span style="color:red;">*</span></label>
                                <select id="lob_id" name="lob_id" class="form-control select2dropdown"
                                    style="width:100%" autocomplete="off" placeholder="Select Lob">
                            ...
                            <div class="form-group col-lg-3 mb-3 pb-0">
                                ...
                                <select id="process_type_id" name="process_type_id" class="form-control select2dropdown"
                                    style="width:100%" autocomplete="off" placeholder="Select Process">
                            ...
                            <div class="form-group col-lg-3 mb-3 pb-0">
                                ...
                                <select class="form-control select2dropdown" style="width:100%" name="process_code"
                                    id="process_code" aria-hidden="true" data-parsley-trigger="focusout keyup"
                                    data-parsley-error-message="Product Code should not be empty"
                                    data-parsley-errors-container="#process_code_error" required>
                            ...
                            <div class="form-group col-lg-3 mb-3 pb-0">
                                ...
                                <select class="form-control select2dropdown" style="width:100%" name="property_state"
                                    id="property_state" aria-hidden="true">
                            ...
                            <div class="form-group col-lg-3 mb-3 pb-0">
                                ...
                                <select id="property_county" name="property_county" type="text"
                                    class="form-control select2dropdown" style="width:100%" autocomplete="off"
                                    placeholder="Enter Property County" data-parsley-trigger="focusout"
                            ...
                            <div class="form-group col-lg-3 mb-3 pb-0" id= "municipality-container">
                                ...
                                <select id="city" name="city" class="form-control select2dropdown"
                                    style="width:100%" autocomplete="off" data-parsley-trigger="focusout keyup">
                            ...
                            <div class="form-group col-lg-3 mb-3 pb-0">
                                ...
                                <select id="order_status" name="order_status" required type="text"
                                    class="form-control" autocomplete="off" placeholder="Enter Status"
                            ...
                            <div class="form-group col-lg-3 mb-3 pb-0">
                                ...
                                <select id="assignee_user" name="assignee_user" type="text"
                                    class="form-control select2dropdown" style="width:100%" autocomplete="off"
                                    placeholder="Enter Status" data-parsley-trigger="focusout"
                                    data-parsley-trigger="keyup">
                                    <option selected disabled value="">Select Assignee</option>
                                    @foreach ($processors as $processor)
                                        <option value="{{ $processor->id }}">
                                            {{ $processor->emp_id . ' (' . $processor->username . ')' }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-lg-3 mb-3 pb-0">
                                ...
                                <select id="assignee_qa" name="assignee_qa" type="text"
                                    ...
                                    @foreach ($qcers as $qcer)
                                        <option value="{{ $qcer->id }}">
                                            {{ $qcer->emp_id . ' (' . $qcer->username . ')' }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-lg-3 mb-3 pb-0" id= "tier-container">
                                <label class="font-weight-bold">Tier</label>
                                <select id="tier_id" name="tier_id" type="text"
                                    class="form-control select2dropdown" style="width:100%" autocomplete="off"
                                    placeholder="Select Tier" data-parsley-trigger="focusout"
                                    data-parsley-trigger="keyup">
    ...
    @endforeach -->
                            ...
                            <div class="form-group col-lg-3 mb-3 pb-0" id= "typist-container">
                                ...
                                <select id="typist_id" name="typist_id" type="text"
                                    class="form-control select2dropdown" style="width:100%" autocomplete="off"
                                    placeholder="Select Typist" data-parsley-trigger="focusout"
                                    data-parsley-trigger="keyup">
                                    <option selected="" disabled="" value="">Select Typist</option>
                                    @foreach ($typists as $typist)
                                        <option value="{{ $typist->id }}">
                                            {{ $typist->emp_id . ' (' . $typist->username . ')' }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group col-lg-3 mb-3 pb-0" id="typist-qc-container">
                                ...
                                <select id="typist_qc_id" name="typist_qc_id" type="text"
                                    class="form-control select2dropdown" style="width:100%" autocomplete="off"
                                    placeholder="Select Typist QC" data-parsley-trigger="focusout"
                                    data-parsley-trigger="keyup">
                                    <option selected="" disabled="" value="">Select Typist QC</option>
                                    @foreach ($typist_qcs as $typist_qc)
                                        <option value="{{ $typist_qc->id }}">
                                            {{ $typist_qc->emp_id . ' (' . $typist_qc->username . ')' }}</option>
                                    @endforeach
                                </select>
                            </div>
                            {{-- 4th end --}}
                ...
                <form id="excelImport" class="p-2" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-0 pb-0 pl-3 pr-3 align-items-center" style="flex-direction: column;">
                        <div class="form-group col-lg-6 mb-2 pb-0">
                            ...
                            <input type="file" id="file" name="file" data-height="75" height="100px"
                                class="form-controlfile suppdoc dropify" accept=".csv,.xlsx,.ods">
    ...
    <script type="text/javascript">
            ...
            let progressResponse = setInterval(() => {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        let progressPercentage = totalJobs === 0 ? 100 : parseInt((completedJobs /
                            totalJobs) * 100);
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response, function(key, value) {
                        $("#lob_id").append('<option value="' + value.id + '">' + value.name +
                            '</option>');
                    });
                },
                error: function(xhr, status, error) {
        ...
        $('#lob_id').on('change', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response, function(key, value) {
                        $("#process_type_id").append('<option value="' + value.id + '">' + value
                            .name + '</option>');
                    });
                },
                error: function(xhr, status, error) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response.process_code, function(key, value) {
                        $("#process_code").append('<option value="' + value.id + '">' + value
                            .project_code + ' ' + '(' + value.process_name + ')' +
                            '</option>');
                    });
                    ...
                    $.each(response.tiers, function(key, value) {
                        if (value.Tier_id !== undefined) {
                            $("#tier_id").append('<option value="' + value.id + '">' + value
                                .Tier_id + '</option>');
                        } else {
        ...
        $(document).ready(function() {
            ...
            $('.dropify').on('change', function(event) {
                ...
                .show(); // Show the element and set text
                } else {
