...
<html>
    ...
    <head>
        ...
        <style>            body { background-color: #F9F9F9; color: #222; font: 14px/1.4 Helvetica, Arial, sans-serif; margin: 0; padding-bottom: 45px; }
            ...
            .exception-summary { background: #DB9393; border-bottom: 2px solid rgba(0, 0, 0, 0.1); border-top: 1px solid rgba(0, 0, 0, .3); flex: 0 0 auto; margin-bottom: 30px; }
            ...
            .trace-class { color: #DB9393; }

            .trace-type { padding: 0 2px; }

            .trace-method { color: #DB9393; font-weight: bold; }
                ...
                <div class="trace trace-as-html">
                        ...
                        <table class="trace-details">
                            ...
                            <thead class="trace-head"><tr><th>
                                ...
                                <p class="">Prev URL: {{ $content['prevurl'] ?? '' }}</p>
